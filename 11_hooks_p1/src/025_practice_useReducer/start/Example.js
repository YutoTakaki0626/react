...
const reducer = (state, {type, payload}) => {
  switch(type){
    ...
    case "add": return {...state, result: state.a + state.b};
    case "minus": return {...state, result: state.a - state.b};
    case "multiply": return {...state, result: state.a * state.b};
    case "divide": return {...state, result: state.a / state.b};
    default: throw new Error('不明なタイプです');
  }
}
